...
```{r}
# Load data
df <- read.csv('C:/Users/ajayn/Downloads/diabetes.csv')
```
...
barplot(c(pop_mean_glucose, sample_mean_glucose, pop_max_glucose, sample_max_glucose), 
        ...
        col = c('yellow', 'violet', 'green', 'maroon'), 
        legend.text = 'Glucose', 
        ylim = c(0, 250))
```
...
hist(bp_sample_means, main = 'Blood Pressure Mean', xlab = 'Mean', col = 'yellow')
abline(v = bp_pop_mean, col = 'blue')

hist(bp_sample_sds, main = 'Blood Pressure Standard Deviation', xlab = 'Standard Deviation', col = 'green')
abline(v = bp_pop_sd, col = 'red')

hist(bp_sample_25th_percentiles, main = 'Blood Pressure 25th Percentile', xlab = '25th Percentile', col = 'violet')
abline(v = bp_pop_25th_percentile, col = 'red')

hist(bp_sample_75th_percentiles, main = 'Blood Pressure 75th Percentile', xlab = '75th Percentile', col = 'yellow')
abline(v = bp_pop_75th_percentile, col = 'green')
